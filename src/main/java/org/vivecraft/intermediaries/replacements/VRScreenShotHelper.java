...
// Since I'm using a custom frame buffer I need to replace some of these utils with my own that use the VRFrameBuffer instead of the default

@SideOnly(Side.CLIENT)
public class VRScreenShotHelper extends ScreenShotHelper {
    ...
    public static ITextComponent saveScreenshot(File gameDirectory, int width, int height, VRFrameBuffer buffer)
    {
        return saveScreenshot(gameDirectory, (String)null, width, height, buffer);
    }

    public static ITextComponent saveScreenshot(File gameDirectory, @Nullable String screenshotName, int width, int height, VRFrameBuffer buffer)
    {
        try
        {
    ...
    public static BufferedImage createScreenshot(int width, int height, VRFrameBuffer framebufferIn)
    {
