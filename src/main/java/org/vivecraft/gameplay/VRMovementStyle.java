...
public class VRMovementStyle
{
    ...
    public void setStyle( String requestedStyle ) {
        ...
        {
            changedStyle = false;
            ((IMinecraftVR)Minecraft.getMinecraft()).printChatMessage("Unknown teleport style requested: " + requestedStyle);
        }

        if (changedStyle && Minecraft.getMinecraft()!=null)
        {
            ((IMinecraftVR)Minecraft.getMinecraft()).printChatMessage("Teleport style (RCTRL-M): " + name);
        }
    }
}
