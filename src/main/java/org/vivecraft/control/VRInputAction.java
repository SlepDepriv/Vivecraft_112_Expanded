...
public class VRInputAction {
	...
	public void pressKey() {
		...
		// && (!Reflector.forgeExists() || Reflector.call(keyBinding, Reflector.ForgeKeyBinding_getKeyModifier) == Reflector.getFieldValue(Reflector.KeyModifier_NONE))
		if (Display.isActive() && awtCode != Keyboard.KEY_NONE && !MCOpenVR.isSafeBinding(keyBinding)) {
