...
public class GuiVRControls extends BaseGuiSettings implements GuiEventEx{
    ...
    public void drawScreen(int par1, int par2, float par3) {
		...
		this.drawCenteredString(this.fontRenderer, I18n.format("vivecraft.messages.controls.1"), this.width / 2, this.height / 2 - this.fontRenderer.FONT_HEIGHT / 2 - this.fontRenderer.FONT_HEIGHT - 3, 16777215);
		this.drawCenteredString(this.fontRenderer, I18n.format("vivecraft.messages.controls.2"), this.width / 2, this.height / 2 - this.fontRenderer.FONT_HEIGHT / 2, 16777215);
		this.drawCenteredString(this.fontRenderer, I18n.format("vivecraft.messages.controls.3"), this.width / 2, this.height / 2 - this.fontRenderer.FONT_HEIGHT / 2 + this.fontRenderer.FONT_HEIGHT + 3, 16777215);
    }
