...
//            VRSettings.VrOptions.HUD_HIDE,
    ...
    public void initGui()
    {
    	...
    	this.buttonList.add(new GuiSmallButtonEx(301, this.width / 2 - 78, this.height / 6 - 14, I18n.format("vivecraft.options." + VrOptions.HUD_HIDE.name()) + ": " + mc.gameSettings.hideGUI));
    	...
    	this.buttonList.add(new GuiButtonEx(302, this.width / 2 - 155  + 160, this.height / 6 +150 ,150,20, I18n.format("vivecraft.options.screen.menuworld.button")));
